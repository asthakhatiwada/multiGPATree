...
#'
#' This function will simulate annotation data and p-values for multiple phenotypes to apply the multGPATree method. Users need to select 6 or more annotations.
#'
...
# simdata <- testdata
# save(simdata, file = "/Users/khatiwadaa/Documents/2. MUSC/Dissertation/R Package/multiGPATree/data/simdata.RData")
